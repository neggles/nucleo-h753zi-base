message(STATUS "Searching for STM32CubeCLT installation...")
...
if(EXISTS ${WINDOWS_ST_CLT_PATH})
    message(STATUS "Found STM32CubeCLT installation at \"${WINDOWS_ST_CLT_PATH}\".")
    set(TOOLCHAIN_DIRECTORIES ${WINDOWS_ST_CLT_PATH})
elseif(EXISTS "${MAC_ST_CLT_PATH}")
    message(STATUS "Found STM32CubeCLT installation at \"${MAC_ST_CLT_PATH}\".")
    set(TOOLCHAIN_DIRECTORIES ${MAC_ST_CLT_PATH})
else()
    message(STATUS "Could not find STM32CubeCLT installation. Falling back to tools available on PATH.")
